...
#download a tar.gz file of pictures to our Pictures directory if it isn't already there - assumes you are online
test -f ~Pictures/pics.tgz || wget -q -O ~/Pictures/pics.tgz http://zonzorp.net/pics.tgz

#unpack the downloaded tar.gz file if it is there, then delete the local copy of the tar.gz file.
