...
sixSidedDie1=$(( RANDOM % range + bias ))
sixSidedDie2=$(( RANDOM % range + bias ))
# sum up the rolls
sum=$(( sixSidedDie1 + sixSidedDie2 ))
average=$(( sum / 2 ))
# display the results
echo "Rolled $sixSidedDie1, and $sixSidedDie2 for a sum of $sum."
#echo "The average for the two dice was $average."
