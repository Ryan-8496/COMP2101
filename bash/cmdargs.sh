...
case $1 in
  "-s"*)
    responce="There are $# things left to process on the command line .-s has been found in the command that is to be run."
    ;;
  "-v"*)
    responce="There are $# things left to process on the command line. -v has been found in the command that is to be run."
    ;;
esac
echo $responce
